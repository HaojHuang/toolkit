...
#assert pybullet.isNumpyEnabled()
...
class BtWorld(object):
    ...
    def reset(self):
        ...
        self.bodies = {} # each body corresponds to one urdf
        self.sim_time = 0.0
    ...
    def get_contacts(self, bodyA):
        ...
        contact_points = self.p.getContactPoints(bodyA.uid)
    ...
    def save_state(self):
        # in-momery save, get the state id that could be used for restoring
